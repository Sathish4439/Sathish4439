...
I am a **Flutter & Full-Stack Developer** based in **Coimbatore, Tamil Nadu, India**, offering professional freelance and full-time software development services across **Coimbatore, Karur, Chennai, and Bangalore**. With **2+ years** of hands-on experience, I build high-performance cross-platform mobile applications (Android, iOS) and scalable web platforms.

I specialize in the **Flutter/Dart** ecosystem for client apps, and **React.js, Node.js, AWS, Prisma, PostgreSQL, and MySQL** for robust back-end/full-stack systems. I have a proven track record of delivering secure, containerized architectures, real-time messaging webhooks, and local database synchronizations.

**I am available for freelance projects (Coimbatore / Remote) as well as full-time software engineering roles.**
...
- Engineered the Judah Food Delivery suite (Customer, Partner, Vendor apps) and the Splendour Park Management Suite for menswear wholesaling and billing in Coimbatore.
...
<div align="center">
  ...
  - 🎯 **Full-time positions** in Software Development (Coimbatore, Bangalore, Chennai)
